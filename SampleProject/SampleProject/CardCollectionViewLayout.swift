...
/// Layout attributes for the CardCollectionViewLayout
open class CardCollectionViewLayoutAttributes: UICollectionViewLayoutAttributes {
    ...
    override open func copy(with zone: NSZone? = nil) -> Any {
        let attribute = super.copy(with: zone) as! CardCollectionViewLayoutAttributes
...
/// The CardCollectionViewLayout provides a card stack layout not quite similar like the apps Reminder and Wallet.
open class CardCollectionViewLayout: UICollectionViewLayout, UIGestureRecognizerDelegate {
    ...
    private var cardCollectionViewLayoutAttributes:[CardCollectionViewLayoutAttributes]!
    ...
    private func generateCardCollectionViewLayoutAttributes() -> [CardCollectionViewLayoutAttributes] {
        var cardCollectionViewLayoutAttributes: [CardCollectionViewLayoutAttributes] = []
        ...
        for itemIndex in startIndex..<endBeforeIndex {
            ...
            let cardLayoutAttribute = CardCollectionViewLayoutAttributes.init(forCellWith: indexPath)
    ...
    private func generateNonRevealedCardsAttribute(_ attribute: CardCollectionViewLayoutAttributes) {
    ...
    private func generateRevealedCardAttribute(_ attribute: CardCollectionViewLayoutAttributes) {
    ...
    private func generateBottomCardsAttribute(_ attribute: CardCollectionViewLayoutAttributes, bottomIndex:inout CGFloat) {
